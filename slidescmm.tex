...
\begin{frame}[fragile]{OSH Principles}
	\framesubtitle{Requirements for the idea behind openness}

	Design decisions
	\begin{itemize}
		\item design for development
		\item design for debugability
		\item understandable
		\item reproducible
		\item makeable
		\item transparent
	...
	\textbf{We need OSH designed with an open source mindset, not just publishing proprietary concepts.}
\end{frame}
	...
	\begin{frame}[fragile]{Coordinate Measurement Machine}
		\framesubtitle{What is it? How is it used?}
