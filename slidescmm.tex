...
\begin{frame}[fragile]{Interoperable}
	\framesubtitle{Seamless integration}
...
\begin{frame}[fragile]{Interoperable}
	\framesubtitle{New tools, new applications}
	
	\begin{columns}
		\begin{column}{0.3\textwidth}
			
			\begin{itemize}
				\item 3d scanner head
				\item robot teaching
				\item digitizer
				\item route capture
			\end{itemize}
		...
		\begin{column}{0.7\textwidth}  %%<--- here
			...
			\includegraphics[width=.95\linewidth]{imgs/screwbarI_4_stick}
